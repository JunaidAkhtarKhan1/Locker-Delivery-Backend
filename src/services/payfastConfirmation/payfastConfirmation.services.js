...
const payfastTransactionService = {
  payfastPaymentConfirmation: async (req, res) => {
    const { basket_id, transaction_id, merchant_amount, err_code } = req.body;
    const orderId = parseInt(basket_id);
    console.log(orderId);
    console.log(err_code);
    console.log(merchant_amount);
    const merchantAmount = parseInt(merchant_amount);
...
module.exports = payfastTransactionService;
